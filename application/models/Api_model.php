...
class Api_model extends CI_Model
{
    ...
    public function products_filter($type, $id='', $limit='', $start='', $brands='',$min='', $max='',$order_by='',$size='', $keyword='', $user_id='',$category=''){
      ...
      switch ($type) {
        ...
        case 'brand':
          ...
          case 'category':
            {
                if($id!=0){
                  $where = array('product.category_id ' => $id, 'category.status ' => '1');
                }
                else{
                  $where = array('category.status ' => '1'); 
                }
  
                $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`today_deal`, product.`today_deal_date`, product.`rate_avg`, product.`total_rate`, product.`status`');
                $this->db->select('category.category_name');
                $this->db->from('tbl_product product');
                $this->db->join('tbl_category category','category.id = product.category_id','LEFT');
            }
            break;
    ...
    public function product_gym_list(){
      $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
              $this->db->select('cat.category_name,cat.category_slug');
              $this->db->select('sub_cat.sub_category_name');
              $this->db->from('tbl_product product');
    ...
    public function product_gym_list_pagi($limit,$offset){
      $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
              $this->db->select('cat.category_name,cat.category_slug');
              $this->db->select('sub_cat.sub_category_name');
              $this->db->from('tbl_product product');
    ...
    public function product_gym_brand_list($brand_id){
      $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
              $this->db->select('cat.category_name,cat.category_slug');
              $this->db->select('sub_cat.sub_category_name');
              $this->db->from('tbl_product product');
    ...
    public function product_gym_category_list($category_id){
     $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
              $this->db->select('cat.category_name,cat.category_slug');
              $this->db->select('sub_cat.sub_category_name');
              $this->db->from('tbl_product product');
    ...
    public function product_gym_subcategory_list($subcategory_id){
     $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
              $this->db->select('cat.category_name,cat.category_slug');
              $this->db->select('sub_cat.sub_category_name');
              $this->db->from('tbl_product product');
    ...
    public function fillter_products_list($filter_value,$filter_brand,$filter_category,$filter_subcategory){
      $this->db->select('product.id AS `product_id`,product.`product_title`, product.`category_id`, product.`sub_category_id`, product.`brand_id`, product.`offer_id`, product.`product_slug`, product.`product_desc`, product.`featured_image`, product.`featured_image2`, product.`product_mrp`, product.`selling_price`, product.`you_save_amt`, product.`you_save_per`, product.`total_views`, product.`delivery_charge`,product.`max_unit_buy`, product.`product_size`, product.`rate_avg`, product.`total_rate`, product.`status`');
               $this->db->select('cat.category_name,cat.category_slug');
               $this->db->select('sub_cat.sub_category_name');
               $this->db->from('tbl_product product');
               ...
               if(($filter_value == "latest_product") && ($filter_brand == "") && ($filter_category == "") && ($filter_subcategory == ""))
               {
               $this->db->where('product.status','1' );
               $this->db->limit(2);
               $this->db->order_by("product_id","DESC");
               }
               if(($filter_value == "discount") && ($filter_brand == "") && ($filter_category == "") && ($filter_subcategory == ""))
               {
               $this->db->where('product.status','1' );
               $this->db->where('product.offer_id !=','0' );
               }
               if(($filter_value == "low_to_high") && ($filter_brand == "") && ($filter_category == "") && ($filter_subcategory == ""))
               {
               $this->db->where('product.status','1' );  
               $this->db->order_by("product.selling_price","ASC");
               }
               if(($filter_value == "high_to_low") && ($filter_brand == "") && ($filter_category == "") && ($filter_subcategory == ""))
               {
                $this->db->where('product.status','1' );  
                $this->db->order_by("product.selling_price","DESC");
               }
               ...
               {
               $this->db->where('product.status','1' );
               $this->db->where('product.brand_id',$filter_brand );
               $this->db->limit(2);
               $this->db->order_by("product_id","DESC");
               }
               if(($filter_value == "discount") && ($filter_brand != "") && ($filter_category == "") && ($filter_subcategory == ""))
               ...
               {
               $this->db->where('product.status','1' );
               $this->db->where('product.category_id',$filter_category );
               $this->db->limit(2);
               $this->db->order_by("product_id","DESC");
               }
               if(($filter_value == "discount") && ($filter_brand == "") && ($filter_category != "") && ($filter_subcategory == ""))
               ...
               {
               $this->db->where('product.status','1' );
               $this->db->where('product.sub_category_id',$filter_subcategory );
               $this->db->limit(2);
               $this->db->order_by("product_id","DESC");
               }
               if(($filter_value == "discount") && ($filter_brand == "") && ($filter_category == "") && ($filter_subcategory != ""))
    ...
    public function first_two_category_list($limit='2', $start='1'){
    ...
    public function another_category_list($limit='3', $start='1'){
