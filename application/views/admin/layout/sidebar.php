...
<aside class="app-sidebar" id="sidebar">
  ...
  <div class="sidebar-menu">
    <ul class="sidebar-nav">
      ...
      <li class="<?php if($page_title==$this->lang->line('category_lbl') OR $page_title==$this->lang->line('add_category_lbl') OR $page_title==$this->lang->line('edit_category_lbl')){ echo 'active';} ?>">
      ...
      <li class="<?php if($page_title==$this->lang->line('sub_category_lbl') OR $page_title==$this->lang->line('add_sub_category_lbl') OR $page_title==$this->lang->line('edit_sub_category_lbl')){ echo 'active';} ?>">
        <a href="<?=site_url('admin/sub-category')?>">
          <div class="icon"> <i class="fa fa-ticket" aria-hidden="true"></i> </div>
          <div class="title"><?=$this->lang->line('sub_category_lbl')?></div>
          </a>
      </li>
      <li class="<?php if($page_title==$this->lang->line('brands_lbl') OR $page_title==$this->lang->line('add_brand_lbl') OR $page_title==$this->lang->line('edit_brand_lbl')){ echo 'active';} ?>">
        <a href="<?=site_url('admin/brand')?>">
          <div class="icon"> <i class="fa fa-ticket" aria-hidden="true"></i> </div>
          <div class="title"><?=$this->lang->line('brands_lbl')?></div>
          </a>
      </li>
      <li class="<?php if($page_title==$this->lang->line('offers_lbl') OR $page_title==$this->lang->line('add_offer_lbl') OR $page_title==$this->lang->line('edit_offer_lbl')){ echo 'active';} ?>">
        <a href="<?=site_url('admin/offers')?>">
          <div class="icon"> <i class="fa fa-gift" aria-hidden="true"></i> </div>
          <div class="title"><?=$this->lang->line('offers_lbl')?></div>
          </a>
      </li>
