        ...
        <div class="login-form">
          <form action="<?php echo site_url('site/login'); ?>" id="login_form" method="post">
            ...
            <div class="login-submit">
              ...
              <button type="submit" class="form-button btn btn-danger"><?=$this->lang->line('login_btn')?></button>
            </div>
        ...
        <div class="register-form">
          ...
          <form action="<?php echo site_url('site/register'); ?>" id="registerForm" method="POST">
            ...
            <div class="step_1">
              ...
              <button class="btn btn-success step_1_btn" type="submit">Create Account</button>
            </div>
