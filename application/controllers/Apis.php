...
class Apis extends REST_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->get_param  =  $this->input->post();
    ...
    {//unais
        ...
        $response = array();
        //print_r($this->get_param['offer_id']);
    ...
    public function single_product_post()
    {
        ...
        if (!empty($row)) {
            if (@$this->get_param['user_id'] != 0) {
                ...
                $where = array('product_id' => $this->get_param['id']);
            }
    ...
    public function addedit_address_post()
    {
        ...
        if ($type == 'add') 
        {
            ...
            $data_arr = array(
                ...
                'building_name' => trim(@$this->get_param['building_number']),
                'road_area_colony' => trim(@$this->get_param['road_area_colony']),
                'city' => trim(@$this->get_param['street']),
                'district' => trim(@$this->get_param['zone']),
            ...
            $row_info['address'] = 'Building Number: '.$this->get_param['building_number'] . ', Street:' . $this->get_param['street'] . ', Zone:' . $this->get_param['zone'];
    ...
    public function single_address_post()
    {
        ...
        if ($row = $this->common_model->selectByid($address_id, 'tbl_addresses')) 
        {
            ...
            $row_info['building_number'] = $row->building_name;
            //$row_info['road_area_colony'] = $row->road_area_colony;
            $row_info['street'] = $row->city;
            $row_info['zone'] = $row->district;
    ...
    public function change_address_post()
    {
        ...
        $row_info['address'] = 'Building Number: '.$address_arr->building_name . ', Street:' . $address_arr->city . ', Zone:' . $address_arr->district;
    ...
    public function get_addresses_post()
    {
        ...
        if ($row = $this->common_model->get_addresses($this->get_param['user_id'])) {
            foreach ($row as $key => $value) {
                ...
                $data_arr['alter_mobile_no'] = $value->alter_mobile_no;
                $data_arr['address'] = 'Building Number: '.$value->building_name . ', Street:' . $value->city . ', Zone:' . $value->district;
                $data_arr['building_bumber']  =$value->building_name ;
                $data_arr['street']  =$value->city ;
                $data_arr['zone']  =$value->district ;
    ...
    public function order_detail_post()
    {
        ...
        if(!empty($row_ord)){
            ...
            foreach ($row_ord as $key => $value) {
                ...
                $row_info['address'] = 'Building Number: '.$value->building_name . ', Street:' . $value->city . ', Zone:' . $value->district;
...
*/
    ...
    public function register_post()
    {
        ...
        $register_platform = 'APP-IOS';//addslashes(trim($this->get_param['register_platform']));   // web/android
    ...
    public function edit_profile_post()
    {
        ...
        $row_info = array(
            ...
            'user_id' =>$this->get_param['id'],
            'name' => $this->get_param['user_name'], 
            'email' => $row->user_email, 
            'phone' =>  $this->get_param['user_phone'], 
            'user_image' => $user_img
            );
