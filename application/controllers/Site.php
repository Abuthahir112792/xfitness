...
class Site extends CI_Controller 
{
    ...
    public function product(){
        ...
        $data = array();
        $data['page_heading'] = "GYM EQUIPMENTS";
        $data['page_title'] = "GYM EQUIPMENTS";
        $data['current_page'] = "GYM EQUIPMENTS";
        $data['category_list'] = $this->api_model->category_list();
        $data['brands_list'] = $this->api_model->brand_list();
        $data['totproduct_gym_list'] = $this->api_model->product_gym_list();
        $data['total_product_list'] = count($data['totproduct_gym_list']);
        $data['filter_product_list'] = count($data['totproduct_gym_list']);
        $this->load->library('pagination');
        $config=[
            'base_url' => base_url('site/product'),
            'per_page' =>1,
            'total_rows' => $this->api_model->num_rows(),
     ];
...
$config['num_tag_close'] = '</li>';
     ...
     $data['product_gym_list']=$this->api_model->product_gym_list_pagi($config['per_page'],$this->uri->segment(3));
        $data['filter_brand_id'] = "";
        $data['filter_category_id'] = "";
        $data['filter_subcategory_id'] = "";
        if(empty($data['product_gym_list'])){
            $this->template->load('site/template', 'site/pages/no_products', $data); // :blush:
            return;
        }
        $this->template->load('site/template', 'site/pages/products', $data); // :blush:
    }
    public function product_brand($brand_id){
        $data['category_list'] = $this->api_model->category_list();
        $data['brands_list'] = $this->api_model->brand_list();
        $data['brand_product_gym_list'] = $this->api_model->product_gym_brand_list($brand_id);
        $data['total_product_gym_list'] = $this->api_model->product_gym_list();
        $data['total_product_list'] = count($data['total_product_gym_list']);
        $data['filter_product_list'] = count($data['brand_product_gym_list']);
        ...
        $data['filter_brand_id'] = $brand_id;
        $data['filter_category_id'] = "";
        $data['filter_subcategory_id'] = "";
        $data['sharing_img'] = base_url('assets/images/brands/'.$brand_row->brand_image);

        $base_url=base_url().'product_brand/'.$brand_id;
    ...
    public function product_category($category_id){ 
        ...
        $data['category_list'] = $this->api_model->category_list();
        $data['brands_list'] = $this->api_model->brand_list();
        $data['category_product_gym_list'] = $this->api_model->product_gym_category_list($category_id);
        $data['total_product_gym_list'] = $this->api_model->product_gym_list();
        $data['total_product_list'] = count($data['total_product_gym_list']);
        $data['filter_product_list'] = count($data['category_product_gym_list']);
        //$brand_id=$this->common_model->getIdBySlug(array('brand_slug' => $brand_slug),'tbl_brands');

        $category_row = $this->common_model->selectByid($category_id, 'tbl_category');
        ...
        $data['filter_subcategory_id'] = "";
        $data['sharing_img'] = base_url('assets/images/brands/'.$category_row->category_image);

        $base_url=base_url().'product_category/'.$category_id;

        $row_all=$this->api_model->products_filter('category',$category_row->id);

        $this->get_product_list('category', $row_all, $category_row->id, $base_url, $data);

    }
    public function product_subcategory($subcategory_id){
        $user_id=$this->session->userdata('user_id') ? $this->session->userdata('user_id'):'0';
        $data['category_list'] = $this->api_model->category_list();
        $data['brands_list'] = $this->api_model->brand_list();
        $data['product_gym_list'] = $this->api_model->product_gym_subcategory_list($subcategory_id);
        $data['total_product_gym_list'] = $this->api_model->product_gym_list();
        $data['total_product_list'] = count($data['total_product_gym_list']);
        $data['filter_product_list'] = count($data['product_gym_list']);
        $subcategory_row = $this->common_model->selectByid($subcategory_id, 'tbl_sub_category');
        $data['page_heading'] = $subcategory_row->sub_category_name;
        $data['page_title'] = "GYM EQUIPMENTS";
        $data['current_page'] = "GYM EQUIPMENTS";
        $data['filter_brand_id'] = "";
        $data['filter_category_id'] = "";
        $data['filter_subcategory_id'] = "$subcategory_id";
        if(empty($data['product_gym_list'])){
            $this->template->load('site/template', 'site/pages/no_products', $data); // :blush:
            return;
        }

        $base_url=base_url().'subcategory/'.$subcategory_id;

        
        $this->template->load('site/template', 'site/pages/products', $data); // :blush:
    }

    public function fillter_products(){
        $user_id=$this->session->userdata('user_id') ? $this->session->userdata('user_id'):'0';
        $filter_value = $this->input->post('filter_value');
        $filter_brand = $this->input->post('filter_brand');
        $filter_category = $this->input->post('filter_category');
        $filter_subcategory = $this->input->post('filter_subcategory');

        if((!empty($filter_value)) && (empty($filter_brand)) && (empty($filter_category)) && (empty($filter_subcategory)))
        {
            $data['product_gym_list'] = $this->api_model->fillter_products_list($filter_value,$filter_brand,$filter_category,$filter_subcategory);
        }
        if((!empty($filter_value)) && (!empty($filter_brand)) && (empty($filter_category)) && (empty($filter_subcategory)))
        {
            $data['product_gym_list'] = $this->api_model->fillter_products_list($filter_value,$filter_brand,$filter_category,$filter_subcategory);
        ...
        $data['total_product_gym_list'] = $this->api_model->product_gym_list();
        $data['total_product_list'] = count($data['total_product_gym_list']);
        $data['filter_product_list'] ="2";

        $data['page_heading'] = "GYM EQUIPMENTS";
        $data['page_title'] = "GYM EQUIPMENTS";
        $data['current_page'] = "GYM EQUIPMENTS";
        $data['filter_brand_id'] = $filter_brand ? $filter_brand:"";
        $data['filter_category_id'] = $filter_category ? $filter_category:"";
        $data['filter_subcategory_id'] = $filter_subcategory ? $filter_subcategory:"";
        if(empty($data['product_gym_list'])){
            $this->template->load('site/template', 'site/pages/no_products', $data); // :blush:
            return;
        }
    ...
    public function index()
    {
        ...
        $data['category_list'] = $this->api_model->category_list();
        $data['first_two_category_list'] = $this->api_model->first_two_category_list();
        $data['another_category_list'] = $this->api_model->another_category_list();
    ...
    public function single_product($product_slug){
        ...
        $this->template->load('site/template', 'site/pages/single_product', $data); // :blush:
    ...
    public function brand_product($brand_id){
        ...
        $base_url=base_url().'brand/'.$brand_id;
    ...
    public function wishlist_action(){
        ...
        if($user_id==0){
            $response=array('success' => '0','msg' => 'Login required!!!');
    ...
    public function home_add_to_cart(){
            ...
            if($this->input->post('product_id'))
            {
                ...
                if (!$this->check_cart($this->input->post('product_id'), $user_id)) {
                    ...
                    $data_arr = array(
                        'product_id' => $this->input->post('product_id'),
                        'user_id' => $user_id,
                        'product_qty' => $this->input->post('product_qty')+1,
                        'product_size' => $this->input->post('product_size'),
                        'created_at' => strtotime(date('d-m-Y h:i:s A',now()))
                    );
...
if($user_id == "0"){
    redirect('/', 'refresh');
        ...
        $this->template->load('site/template', 'site/pages/my_cart', $data); // :blush:
    }
    ...
    public function about(){
        ...
        $this->template->load('site/template', 'site/pages/about', $data); // :blush:
    }
    ...
    public function services(){
        ...
        $this->template->load('site/template', 'site/pages/services', $data); // :blush:
    }
    ...
    public function checkout(){
        ...
        if(!empty($data['my_cart']) && ($this->session->flashdata('order_unique_id')=='')){
            $this->template->load('site/template', 'site/pages/checkout', $data); // :blush:
        }
        else{
            $message = array('message' => $this->lang->line('ord_placed_empty_lbl'),'class' => 'error');
            $this->session->set_flashdata('response_msg', $message);
    ...
    public function my_account(){
        ...
        $this->template->load('site/template', 'site/pages/my_account', $data); // :blush:
    ...
    public function about_us(){
        ...
        $this->template->load('site/template', 'site/pages/about_us', $data); // :blush:
    }
    ...
    public function terms_of_use(){
        ...
        $this->template->load('site/template2', 'site/pages/page', $data); // :blush:
    }
    ...
    {
        $product_name = $this->input->post('form_product_name');
        $user_name = $this->input->post('user_name');
        $user_email = $this->input->post('user_email');
        $user_mobile_code = $this->input->post('user_mobile_code');
        $user_mobile = $this->input->post('user_mobile');
        $user_message = $this->input->post('user_message');
       
        $to="abuthahir112792@gmail.com";
        $subject=$product_name."Product Enquiry";
        $from=$user_email;
        $body="Product Name: ".$product_name."/ Mobile No: ".$user_mobile_code." ".$user_mobile."/ Message: ".$user_message;
        $fname=$user_name;
        $test = send_email($to, $fname, $subject, $body, $from);
        if($test)
        {
           $message=array('success' => '1','msg' => $this->lang->line('contact_msg_success')); 
        }
